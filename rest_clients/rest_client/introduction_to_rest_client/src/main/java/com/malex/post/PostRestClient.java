...
public class PostRestClient {
  ...
  private static final Logger LOG = Logger.getLogger(PostRestClient.class.getName());
  ...
  */
  public PostRestClient(@Value("${webservice.client.url}") String url, RestClient.Builder builder) {
